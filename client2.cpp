...
int main(){
    ...
    readFile.open("client2.txt",ios::in);
    if(!readFile)
    {perror("can't open!");
        exit(-1);
    }
    my_Client client2[12];
    
    /*code*/
    for(i=0;i<12;i++)
        readFile>>client2[i].search>>client2[i].key;
    ...
    cout<<"The Client 2 has received a request with search word "<<search;
    ...
    cout<<"The Client 2 sends the request "<<sendmsg<<" to the Server 1 with port number "<<ntohs(tmp->sin_port);
    cout<<" and IP address "<<udp_ip<<"."<<endl;
    cout<<"The Client2’s port number is "<<ntohs(addrLocal.sin_port);
    ...
    cout<<"The Client 2 received the value "<<(buf+5)<<" from the Server 1 ";
    cout<<" with port number "<<ntohs(tmp->sin_port)<<" and IP address "<<udp_ip<<"."<<endl;
    cout<<"The Client2’s port number is "<<ntohs(addrLocal.sin_port)<<" and IP address is "<<udp_ip<<"."<<endl;
